  ...
  return (
    <>
      ...
      <div className="bg-gray-50 min-h-full">
        <Header
          subtitle={name === "std" ? "الوحدات القياسة" : "وحدات الطرف الثالث"}
          widerContent={true}
        />
          ...
          <div className="mt-8">
            {(() => {
              if (versions === null) {
                ...
                return (
                  <ErrorMessage
                    title="لم يتم رفع اي نسخة"
                    body={`اسم هذه الوحدة محجوز لكن لم يتم رفع اي اصدار بعد، سيتم حذف الوحدة اذا لم يتم رفع اي اصدار خلال 30 يوم. ${
                      versions.isLegacy
                        ? "إذا كنت مالك هذه الوحدة ، فيرجى إعادة إضافة مستودع GitHub مع deno.land/x (باتباع الإرشادات الموجودة على https://deno.land/x#add) ، ونشر إصدار جديد."
                        : ""
                    }`}
                  />
                );
                    ...
                    {(() => {
                      if (
                        ...
                        return (
                          <ErrorMessage
                            title="404 - Not Found"
                            body="لا يوجد هذا الاصدار من هذه الوحدة."
                          />
                        );
                      } else if (
                        versionMeta &&
                        ...
                        return (
                          <ErrorMessage
                            title="404 - Not Found"
                            body="لم نتمكن من ايجاد هذا الملف او مجلد .."
                          />
                        );
                          ...
                          <>
                            ...
                            <div className="mt-2 flex items-center py-0.5">
                              <svg
                                ...
                                viewBox="0 0 20 20"
                              >
                                <title>عدد النجوم على جيتهاب</title>
                          ...
                          <>
                            ...
                            <div className="mt-2 flex items-center">
                              <svg
                                ...
                                viewBox="0 0 20 20"
                              >
                                <title>عدد النجوم على جيت هاب</title>
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                              </svg>
